...
train_save_path = '/Users/annayang26/Desktop/CellposeTraining/' + f'{img_path}_{pos}.tif'
tifffile.imwrite(train_save_path, cyto_frame, imagej=True)

img_save_path = '/Users/annayang26/Desktop/CellposeTraining/image/' + f'{img_path}_{pos}.tif'
