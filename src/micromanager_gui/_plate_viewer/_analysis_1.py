...
from ._analysis_gui import _CalciumAnalysisGUI
...
class _ProgressBarWidget(QWidget):
    ...
    def set_elapsed_time_label(self, elapsed_time: str) -> None:
...
class _AnalyseCalciumTraces(QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        self._elapsed_timer.elapsed_time_updated.connect(self._pbar.set_elapsed_time_label)

        self._analysys_settings_gui = _CalciumAnalysisGUI(self)

        # PROGRESS BAR AND RUN/CANCEL BUTTONS -------------------------------------
        self._progress_bar_wdg = _ProgressBarWidget(self)
        ...
        gui_layout = cast(QVBoxLayout, self._analysys_settings_gui.layout())
        ...
        self._progress_bar_wdg.updated.connect(
            self._progress_bar_wdg.auto_update
        )
    ...
    def stimulation_area_path(self) -> str:
        return (
            self._analysys_settings_gui._experiment_type_wdg.value().stimulation_area_path
        )

    @stimulation_area_path.setter
    def stimulation_area_path(self, path: str | None) -> None:
        self._analysys_settings_gui._experiment_type_wdg._stimulation_area_path_dialog.setValue(
            path or ""
        )
    ...
    def run(self) -> None:
        ...
        self._pbar.set_elapsed_time_label(f"[0/{self._pbar.maximum()}]")
    ...
    def _enable(self, enable: bool) -> None:
        ...
        self._analysys_settings_gui.enable(enable)
    ...
    def _save_settings_as_json(self) -> None:
        ...
        try:
            ...
            values = self._analysys_settings_gui.value()
            ...
            settings[PEAKS_PROMINENCE_MULTIPLIER] = values.calcium_peaks_data.peaks_prominence  # noqa: E501
